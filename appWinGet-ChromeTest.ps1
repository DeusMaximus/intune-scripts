...
$appDescription = "Continue your browsing experience from desktop to phone on Chrome. Download today. Now more simple, secure, and faster than ever - with Google's smarts built in."
...
$appInfoURL = "https://www.google.com/chrome/"
$appPrivacyURL = "https://www.google.com/chrome/privacy/" 
...
$DetectionRule = New-IntuneWin32AppDetectionRuleFile -Existence -Path %PROGRAMFILES%\Google\Chrome\Application\ -FileOrFolder Chrome.exe -DetectionType exists
...
$ImageFile = "C:\Intune\Icons\chrome.png"
